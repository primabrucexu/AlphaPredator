...
FIVE_MIN_LEVEL_TRADE_DATA_SCHEMA_SQL = '''
CREATE TABLE IF NOT EXISTS "5m_level_trade_data"
(
    ...
    pre_close DECIMAL(20, 6) NOT NULL DEFAULT 0,
    change DECIMAL(20, 6) NOT NULL DEFAULT 0,
    pct_chg DECIMAL(20, 6) NOT NULL DEFAULT 0,
    vol DECIMAL(24, 6) NOT NULL DEFAULT 0,
