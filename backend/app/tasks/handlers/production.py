...
from .mode_screening import ModeScreeningAnalysisHandler, TASK_TYPE as MODE_SCREENING_TASK_TYPE
...
def register_production_handlers() -> None:
    ...
    register_handler(MODE_SCREENING_TASK_TYPE, ModeScreeningAnalysisHandler())
