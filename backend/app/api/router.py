...
from app.api.routes.macd_alert import router as macd_alert_router
from app.api.routes.market import router as market_router
from app.api.routes.stock_linkage import router as stock_linkage_router
...
api_router.include_router(stock_linkage_router, prefix='/stock-linkage', tags=['股票联动'])
api_router.include_router(macd_alert_router, prefix='/macd-alerts', tags=['MACD预警'])
